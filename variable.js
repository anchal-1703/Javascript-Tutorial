...
//there are 3 waya to define variables in javascript
...
show();
// 4. global - global scope (new way) - cannot be reassigned
// 5. window - global scope (new way) - cannot be reassigned
// 6. this - global scope (new way) - cannot be reassigned
// 7. globalThis - global scope (new way) - cannot be reassigned
